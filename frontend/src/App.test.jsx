...
describe('portfolio', () => {
  ...
  test('keeps developer.js stable without orbit graphics and places Projects immediately after Home', () => {
    ...
    expect(screen.getByAltText('Neo Belolo primary profile avatar')).toHaveAttribute('src', '/profile-character.png')
    expect(screen.getByAltText('Neo Belolo photo revealed on hover')).toHaveAttribute('src', '/profile.png')
